...
# Manzil kodda YO'Q (loyiha qoidasi: manzillar faqat .env'dan) —
# `TTS_API` muhit o'zgaruvchisi yoki `--api` bilan beriladi.
API_DEFAULT = os.environ.get("TTS_API", "")
...
def main() -> None:
    ...
    a = ap.parse_args()
    if not a.api:
        sys.exit("TTS xizmati manzili ko'rsatilmagan: TTS_API=http://<tts-server>:<port> muhit o'zgaruvchisini yoki --api ni bering")
