...
type TopKey = "product" | "campus" | "presentation" | "docs" | "about" | "pricing";
...
const PLAIN_ICONS: Partial<Record<TopKey, LucideIcon>> = { presentation: Presentation, docs: BookOpen, about: Users, pricing: Tag };
